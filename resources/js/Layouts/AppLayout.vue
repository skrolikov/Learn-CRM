...
// Массив навигационных элементов для sidebar.
const navItems = [
    { name: 'Dashboard', icon: 'pi pi-home', route: 'dashboard' },
    { name: 'Заявки', icon: 'pi pi-users', route: 'orderspage' },
]
</script>
...
<template>
    <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:bg-gray-900">
                            ...
                            <Dropdown align="right" width="48">
                                <template #trigger>
                                    <button v-if="$page.props.jetstream.managesProfilePhotos"
                                        class="flex text-xl border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                    <div class="flex items-center px-4">
                        <div v-if="$page.props.jetstream.managesProfilePhotos" class="shrink-0 me-3">
                            <img class="size-10 rounded-2xl object-cover"
        ...
        <div class="min-h-screen mt-4 px-4 sm:px-6 lg:px-8   flex">
            <!-- Левый sidebar -->
            <aside class="bg-white/50 h-full p-2 rounded-2xl flex flex-col items-center space-y-6">

                <!-- Навигационные ссылки -->
                <div class="flex flex-col items-center space-y-4">
                    <template v-for="item in navItems" :key="item.name">
                        <Link :href="route(item.route) "
                            class="p-4 hover:bg-gray-400/25 dark:hover:bg-gray-700 text-center h-16 w-16 rounded-xl"
